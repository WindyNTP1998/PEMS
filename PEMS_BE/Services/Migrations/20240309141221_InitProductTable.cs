        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PackageUnit = table.Column<string>(type: "text", nullable: false),
                    ProductForm = table.Column<string>(type: "text", nullable: false),
                    ProductRanking = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_LastUpdatedDate",
                table: "Product",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategory_CategoryId_Id",
                table: "ProductCategory",
                columns: new[] { "CategoryId", "Id" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductCategory_ProductId_Id",
                table: "ProductCategory",
