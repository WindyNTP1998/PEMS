...
public static class ActionExtension
{
	...
	{
		return () => { return action().Then(() => (object)ValueTuple.Create()); };
	}
	...
	{
		return t => { return action(t).Then(() => (object)ValueTuple.Create()); };
	}
	...
	{
		return (t1, t2) => { return action(t1, t2).Then(() => (object)ValueTuple.Create()); };
	}
}